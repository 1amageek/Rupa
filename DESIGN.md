...
the RupaKit package design. Its JSON/CLI and responsiveness tools are owned by
the separate [RupaBenchmarks package design](RupaBenchmarks/DESIGN.md), another
direct system child. The T09
...
|---|---|---|---|---|
| [RupaBenchmarks package](RupaBenchmarks/DESIGN.md) | child | T12 and responsiveness verification | Owns independent benchmark tools and restored evidence assets. | Depends on public RupaKit products; never a production dependency. |
| [RupaKit package](RupaKit/DESIGN.md) | child | T10 production API composition | Indexes Project, RupaKit, AgentProtocol, and AgentRuntime ownership. | External verification composition belongs to RupaBenchmarks. |
