...
|---|---|---|---|---|
| [RupaBenchmarks package design](../../DESIGN.md) | parent | Package composition and target index | Registers this executable as an upper-level measurement support target. | Production authority modules must not depend on it. |
