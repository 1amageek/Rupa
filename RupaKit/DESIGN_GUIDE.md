...
| Ruler editing | Inspector ruler fields should present readable units for the current magnitude, accept explicit length units, and persist canonical meters. |
