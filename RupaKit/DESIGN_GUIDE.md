...
| Length editing | Inspector length fields should present readable units for the current magnitude, accept explicit length units, use large-range slider scaling, and persist canonical meters. |
