...
/// press route resolves a body edit baseline and commits a body-move command,
/// so a sketch borrowing that identity would be moved as if it were a body.
/// This family is the sketch's own, and the scene node it names is the commit
/// target the workspace addresses.
