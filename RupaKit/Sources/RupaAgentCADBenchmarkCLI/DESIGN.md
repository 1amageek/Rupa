...
`request` validates that the ID is in the activated 82-case set and emits
...
- `request` emits valid v1 JSON for an activated line, rectangle, REC-009
  ...
  BOX-001...012, `CYL-001...008`, `CON-001...008`, `TRN-001`, and `TRN-002`, and rejects inactive `TRN-003`;
- JSON line, rectangle, circle, angle, BOX-001...012, CYL-001...008, CON-001...008, and TRN-001/TRN-002 transform responses traverse the adapter, production
...
### TRN-001 and TRN-002 current process boundary

The current executable authority is the exact ordered 82-case prefix
...
`request TRN-001` and `request TRN-002` emit one bounded transform context. An
exact v7 response
...
TRN-001 translation with x = 26 mm and TRN-002 wrong-order translation
`(-17.67766952966369, 17.67766952966369, 0)` mm exit `2` as
