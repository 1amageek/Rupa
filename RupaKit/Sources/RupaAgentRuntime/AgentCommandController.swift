            ...
            optionMatrix: [
                ...
                AgentCapabilityDescriptor.OptionAxis(
                    ...
                    notes: [
                        ...
                        "one or more open guide curves can add rail-following intermediate section rings for two-section Loft",
                        "higher-order smooth Loft surfaces and multi-section rail deformation remain unsupported"
                    ]
                ),
                AgentCapabilityDescriptor.OptionAxis(
