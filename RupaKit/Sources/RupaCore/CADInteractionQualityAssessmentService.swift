            ...
            evidence: [
                CADInteractionQualityEvidence(
                    ...
                    notes: [
                        ...
                        "Rendered mesh clipping, clipping-side viewport controls, interference highlighting, persistent section-distance controls, and drawing/export section hatching remain incomplete.",
                    ]
                ),
            ],
            openWork: [
                "Rendered mesh clipping and clipping-side viewport controls driven by the non-mutating SectionAnalysisResult.",
