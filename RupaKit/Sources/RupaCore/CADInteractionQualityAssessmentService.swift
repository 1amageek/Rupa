            ...
            evidence: [
                CADInteractionQualityEvidence(
                    ...
                    notes: [
                        ...
                        "Rendered mesh clipping, interference highlighting, persistent section-distance controls, and drawing/export section hatching remain incomplete.",
                    ]
                ),
            ],
            openWork: [
                "Rendered mesh clipping and clipping-side UI driven by the non-mutating SectionAnalysisResult.",
