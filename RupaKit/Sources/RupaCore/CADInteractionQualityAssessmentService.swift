            ...
            evidence: [
                CADInteractionQualityEvidence(
                    ...
                    notes: [
                        ...
                        "SwiftCAD exposes the shared Boolean kernel decision and result topology name scheme as a non-mutating plan service, and Agent exposes it as document.booleanEvaluationPlan before createBoolean.",
