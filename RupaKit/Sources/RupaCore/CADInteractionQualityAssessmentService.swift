            ...
            evidence: [
                CADInteractionQualityEvidence(
                    ...
                    notes: [
                        ...
                        "Automation command results now expose primaryFeatureID for source-owned solid and surface creation commands, so Agent Boolean workflows can bind a preflight plan to the exact created feature before querying topologySummary.",
