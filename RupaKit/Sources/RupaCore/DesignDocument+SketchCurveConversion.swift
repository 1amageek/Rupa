...
extension DesignDocument {
    ...
    private func constraintsAfterLineToArcConversion(
        ...
        constraints.compactMap { constraint -> SketchConstraint? in
            switch constraint {
            ...
            case .splineEndpointTangent(let lineTangency):
                return lineTangency.line == entityID ? nil : constraint
    ...
    private func constraintsAfterLineToSplineConversion(
        ...
        try constraints.map { constraint in
            ...
            case .horizontal,
                ...
                return constraint
            case .splineEndpointTangent(let lineTangency):
                guard lineTangency.line == entityID else {
                    return constraint
                }
                let source = lineTangency.splineEndpoint
