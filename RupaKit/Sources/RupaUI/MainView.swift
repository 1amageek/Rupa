...
private struct SnappedModelInput {
    var point: Point2D
...
public struct MainView: View {
    ...
    private struct InspectorSketchEntity: Equatable {
    ...
    private struct InspectorBridgeCurve: Equatable {
    ...
    private struct InspectorBridgeCurveTension: Equatable {
        var first: Double
        var second: Double
        var third: Double
    }

    private enum InspectorBridgeCurveEndpoint {
        case first
        case second
    }

    private enum InspectorBridgeCurveTensionLevel {
        case first
        case second
        case third
    }

    private struct InspectorCurveAnalysis: Equatable {
        var sampleCount: Int
    ...
    private struct InspectorCurveContinuityJoin: Identifiable, Equatable {
        var id: String
    ...
    private struct InspectorSurfaceContinuity: Equatable {
    ...
    private struct InspectorSurfaceAdjacency: Identifiable, Equatable {
        var id: String
    ...
    private struct InspectorSurfaceAnalysis: Equatable {
        var bSplineFaceCount: Int
        var sampleCount: Int
    ...
    private struct InspectorSurfaceFaceAnalysis: Identifiable, Equatable {
        var id: String
    ...
    private struct InspectorSketchLineCandidate: Identifiable, Equatable {
        var id: SketchEntityID
        var start: SketchEntitySummaryResult.Point
        var end: SketchEntitySummaryResult.Point
    }

    private struct InspectorSplineEndpointCandidate: Identifiable, Equatable {
