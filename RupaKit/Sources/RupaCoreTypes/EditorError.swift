...
public struct EditorError: Error, Codable, Equatable, Sendable {
    public enum Code: String, Codable, Sendable {
        ...
        case documentTransactionRevisionMismatch = "document.transactionRevisionMismatch"
        ...
        case commandUnsupported = "command.unsupported"
        case commandFailed = "command.failed"
        case projectMismatch = "project.mismatch"
        case projectPublicationMismatch = "project.publicationMismatch"
