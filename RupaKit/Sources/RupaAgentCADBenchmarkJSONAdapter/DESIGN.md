...
The adapter is limited to the 92 reviewed cases `LIN-001`...`LIN-012`,
`REC-001`...`REC-012`, `CIR-001`...`CIR-012`, `ANG-001`...`ANG-016`,
`BOX-001`...`BOX-012`, `CYL-001`...`CYL-008`, `CON-001`...`CON-008`, and
`TRN-001`...`TRN-008`, and `CMP-001`...`CMP-004`. It does not activate a catalog case and does not make the
...
The activated ninety-two cases accept one action decision. `unsupported` and
...
### CMP-004 current external authority contract

The current adapter authority appends `CMP-004` as the 92nd case; `CMP-005`
remains typed inactive. Its public challenge declares ordered roles `plate`,
