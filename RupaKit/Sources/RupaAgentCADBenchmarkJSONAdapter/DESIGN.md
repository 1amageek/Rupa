...
The adapter is limited to the forty-six reviewed cases `LIN-001`...`LIN-012`,
`REC-001`...`REC-012`, `CIR-001`...`CIR-012`, and `ANG-001`...`ANG-010`. It does not
...
The activated forty-six cases accept one action decision. `unsupported` and
