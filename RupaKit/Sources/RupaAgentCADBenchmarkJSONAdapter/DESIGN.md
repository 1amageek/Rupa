...
The adapter is limited to the forty-four reviewed cases `LIN-001`...`LIN-012`,
`REC-001`...`REC-012`, `CIR-001`...`CIR-012`, and `ANG-001`...`ANG-008`. It does not
...
The activated forty-four cases accept one action decision. `unsupported` and
