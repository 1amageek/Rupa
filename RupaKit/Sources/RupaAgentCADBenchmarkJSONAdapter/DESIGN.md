...
The adapter is limited to the 98 reviewed cases `LIN-001`...`LIN-012`,
`REC-001`...`REC-012`, `CIR-001`...`CIR-012`, `ANG-001`...`ANG-016`,
`BOX-001`...`BOX-012`, `CYL-001`...`CYL-008`, `CON-001`...`CON-008`, and
`TRN-001`...`TRN-008`, `CMP-001`...`CMP-007`, and `SPH-001`...`SPH-003`. It does not activate a catalog case and does not make the
...
### SPH-003 current external authority contract

The current adapter authority appends `SPH-003` as the 98th case and leaves
`SPH-004` typed inactive. Its public challenge requests one analytic sphere of
