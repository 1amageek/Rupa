...
public struct RupaPreviewSurface: View {
    ...
    private let diagnostics: [RupaDiagnostic]
    ...
    private func icon(for severity: RupaDiagnostic.Severity) -> String {
        switch severity {
        case .info:
            "info.circle"
        case .warning:
    ...
    private func color(for severity: RupaDiagnostic.Severity) -> Color {
        switch severity {
        case .info:
            .secondary
        case .warning:
