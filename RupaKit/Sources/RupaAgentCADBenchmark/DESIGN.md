...
| `CADActivatedCircleCase` | Internal; the reviewed circle IDs that may enter behavioral execution | Began with CIR-001, currently contains CIR-001...010, and advances one reviewed case per later commit |
...
continuation, activate unreviewed IDs such as `CIR-011`, schedule several cases, or establish a
benchmark baseline.
...
`T12-CIR-010` advances the same authority to the exact thirty-four-case prefix
...
keeps CIR-011 typed inactive. No shared circle infrastructure, schema, catalog,
