...
| `CADActivatedTransformCase` | Internal; the reviewed transform IDs that may enter behavioral execution | Contains TRN-001 and TRN-002; TRN-003...008 remain catalog-only until their own vertical gates |
...
TRN-001/TRN-002 transform automation payloads proven by activated cases. The angle
...
pivot and composition semantics are fixed, and TRN-003...008 remain catalog-only
...
to `expectedUnsupported`, because all eighty-two activated cases have already
...
### TRN-001 and TRN-002 current activation boundary

TRN-001 and TRN-002 have crossed their individual vertical gates. The
executor-owned ordered authority is now exactly 82 IDs: LIN-001...012,
REC-001...012, CIR-001...012, ANG-001...016, BOX-001...012, CYL-001...008,
CON-001...008, TRN-001, and TRN-002. TRN-003...008 remain catalog-only and are
...
mm publish once and fail without retry, while a zero axis fails before
publication. TRN-002 is a sketch-only source with two reads, one feature, one
authored scene node, and zero bodies. The same production route owns cleanup and
telemetry.
...
aggregate as
`9ca519a087729b5aa46e549ef3ec6f903158a8aff159dce2bcce09182f0b46ef`. The
