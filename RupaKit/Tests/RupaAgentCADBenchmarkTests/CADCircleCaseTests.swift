...
struct CADCircleCaseTests {
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func executorRetainsCIR001ThroughCIR012AfterBOX012Activation() async throws {
        ...
        #expect(executor.activatedCaseIDs.prefix(94).last?.rawValue == "CMP-006")
        #expect(executor.activatedCaseIDs.prefix(95).last?.rawValue == "CMP-007")
        #expect(executor.activatedCaseIDs.prefix(96).last?.rawValue == "SPH-001")
        #expect(executor.activatedCaseIDs.last?.rawValue == "SPH-002")
        ...
        do {
            ...
            Issue.record("SPH-003 must remain inactive until its vertical gate.")
