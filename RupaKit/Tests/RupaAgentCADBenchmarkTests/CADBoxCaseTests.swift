...
struct CADBoxCaseTests {
    ...
    func activatedBoxBoundaryContainsOnlyReviewedCases() throws {
        #expect(CADActivatedBoxCase.allCases == [.box001, .box002, .box003, .box004, .box005, .box006, .box007, .box008, .box009, .box010, .box011])
        for rejectedCaseID in ["BOX-012", "REC-001", "CIR-001"] {
            do {
