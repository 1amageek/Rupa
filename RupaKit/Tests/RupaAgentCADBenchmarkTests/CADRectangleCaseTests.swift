...
struct CADRectangleCaseTests {
    ...
    func activatedRectangleBoundaryMatchesReviewedCases() throws {
        #expect(CADActivatedRectangleCase.allCases == [.rec001, .rec002, .rec003, .rec004, .rec005, .rec006, .rec007, .rec008, .rec009, .rec010, .rec011])

        for rejectedCaseID in ["REC-012", "LIN-001"] {
            do {
