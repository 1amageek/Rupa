...
struct CADJSONAdapterTests {
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func cylinder003WireActionExecutesTranslatedYAxisProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CYL-003")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder003Action(name: "CYL-003"))
        )
        let requestJSON = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseJSON = String(decoding: try CADJSONBoundedCodec.encode(response), as: UTF8.self)

        #expect(requestJSON.contains("base center (-50.0, 20.0, 10.0) mm"))
        #expect(requestJSON.contains("radius 25.0 mm and depth 100.0 mm"))
        #expect(responseJSON.contains("\"axis\":{\"x\":0,\"y\":1,\"z\":0}"))

        let evaluation = try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(response))
        #expect(evaluation.caseID == "CYL-003")
        #expect(evaluation.result?.outcome == .realized)
        #expect(evaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder003Action(
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func cylinder004WireActionExecutesNegativeZProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CYL-004")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder004Action(name: "CYL-004"))
        )
        let requestJSON = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseJSON = String(decoding: try CADJSONBoundedCodec.encode(response), as: UTF8.self)
        #expect(requestJSON.contains("base center (0.0, 0.0, -100.0) mm"))
        #expect(requestJSON.contains("radius 50.0 mm and depth 250.0 mm"))
        #expect(responseJSON.contains("\"axis\":{\"x\":0,\"y\":0,\"z\":-1}"))
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder004Action(
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func cylinder005WireActionExecutesCentimeterDiagonalProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CYL-005")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder005Action(name: "CYL-005"))
        )
        let requestJSON = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        #expect(requestJSON.contains("radius 2.0 cm and depth 10.0 cm"))
        #expect(requestJSON.contains("axis (0.707106781187, 0.707106781187, 0.0)"))
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder005Action(
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func cylinder007WireActionExecutesInchNegativeXProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CYL-007")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder007Action(name: "CYL-007"))
        )
        let requestJSON = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        #expect(requestJSON.contains("base center (2.0, 3.0, -1.0) in"))
        #expect(requestJSON.contains("radius 1.0 in and depth 4.0 in"))
        #expect(requestJSON.contains("axis (-1.0, 0.0, 0.0)"))
        let evaluation = try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(response))
        #expect(evaluation.result?.outcome == .realized)
        #expect(evaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder007Action(
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func cylinder008WireActionExecutesThreeAxisDiagonalProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CYL-008")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder008Action(name: "CYL-008"))
        )
        let requestJSON = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        #expect(requestJSON.contains("base center (100.0, 100.0, 100.0) mm"))
        #expect(requestJSON.contains("radius 75.0 mm and depth 150.0 mm"))
        #expect(requestJSON.contains("axis (0.57735026919, 0.57735026919, 0.57735026919)"))
        let evaluation = try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(response))
        #expect(evaluation.result?.outcome == .realized)
        #expect(evaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(cylinder008Action(
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con001WireActionExecutesExactCoincidentProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-001")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint001Action(name: "CON-001"))
        )
        ...
        let evaluation = try await adapter.evaluate(responseData: responseData)
        #expect(evaluation.result?.outcome == .realized)
        #expect(evaluation.error == nil)
        ...
        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint001Action(name: "CON-001.wrong", firstStartX: 10))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrong)
        )
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
        ...
        let invalid = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint001Action(name: "CON-001.invalid", secondEndY: 19))
        )
        let invalidEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(invalid)
        )
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con002WireActionExecutesExactParallelProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-002")
        let response = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint002Action(name: "CON-002"))
        )
        let responseData = try CADJSONBoundedCodec.encode(response)
        let responseText = String(decoding: responseData, as: UTF8.self)

        #expect(request.context.challenge.instruction.contains("parallel relation"))
        #expect(responseText.contains("\"relation\":\"parallel\""))
        #expect(responseData.count < 16_384)
        let evaluation = try await adapter.evaluate(responseData: responseData)
        #expect(evaluation.result?.outcome == .realized)
        #expect(evaluation.error == nil)
        ...
        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint002Action(
                name: "CON-002.wrong",
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con003WireActionExecutesExactPerpendicularProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-003")
        let exact = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint003Action(name: "CON-003"))
        )
        ...
        #expect(String(decoding: exactData, as: UTF8.self).contains("\"relation\":\"perpendicular\""))
        #expect(try await adapter.evaluate(responseData: exactData).result?.outcome == .realized)

        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint003Action(name: "CON-003.wrong", relation: .parallel))
        )
        #expect(try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrong)
        ...
        let invalid = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint003Action(name: "CON-003.invalid", firstEndX: 0))
        )
        #expect(try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(invalid)
        ).result?.outcome == .invalidSubmission)
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con004WireActionExecutesExactHorizontalProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-004")
        let exact = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint004Action(name: "CON-004"))
        )
        let exactData = try CADJSONBoundedCodec.encode(exact)
        #expect(request.context.challenge.instruction.contains("horizontal relation"))
        #expect(String(decoding: exactData, as: UTF8.self).contains("\"relation\":\"horizontal\""))
        #expect(try await adapter.evaluate(responseData: exactData).result?.outcome == .realized)

        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint004Action(name: "CON-004.wrong", relation: .vertical))
        )
        ...
        let invalid = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint004Action(name: "CON-004.invalid", includeSecond: true))
        )
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con005WireActionExecutesExactVerticalProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-005")
        let exact = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint005Action(name: "CON-005"))
        )
        let exactData = try CADJSONBoundedCodec.encode(exact)
        #expect(request.context.challenge.instruction.contains("vertical relation"))
        #expect(String(decoding: exactData, as: UTF8.self).contains("\"relation\":\"vertical\""))
        #expect(try await adapter.evaluate(responseData: exactData).result?.outcome == .realized)

        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint005Action(name: "CON-005.wrong", relation: .horizontal))
        )
        #expect(try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(wrong)).result?.outcome == .invalidSubmission)
        ...
        let invalid = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint005Action(name: "CON-005.invalid", includeSecond: true))
        )
        #expect(try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(invalid)).result?.outcome == .invalidSubmission)
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con007WireActionExecutesExactConcentricProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-007")
        let exact = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint007Action(name: "CON-007"))
        )
        let exactData = try CADJSONBoundedCodec.encode(exact)
        #expect(request.context.challenge.instruction.contains("concentric relation"))
        #expect(String(decoding: exactData, as: UTF8.self).contains("\"relation\":\"concentric\""))
        #expect(try await adapter.evaluate(responseData: exactData).result?.outcome == .realized)

        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint007Action(name: "CON-007.wrong", relation: .equalRadius, secondRadius: 10))
        )
        #expect(try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(wrong)).result?.outcome == .invalidSubmission)
        ...
        let invalid = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint007Action(name: "CON-007.invalid", firstRadius: 0))
        )
        #expect(try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(invalid)).result?.outcome == .invalidSubmission)
    ...
    @MainActor @Test(.timeLimit(.minutes(1)))
    func con008WireActionExecutesExactEqualRadiusProductionRoute() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CON-008")
        let exact = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint008Action(name: "CON-008"))
        )
        let exactData = try CADJSONBoundedCodec.encode(exact)
        #expect(request.context.challenge.instruction.contains("equalRadius relation"))
        #expect(String(decoding: exactData, as: UTF8.self).contains("\"relation\":\"equalRadius\""))
        #expect(try await adapter.evaluate(responseData: exactData).result?.outcome == .realized)

        let wrong = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint008Action(
                name: "CON-008.wrong",
                relation: .concentric,
                secondCenterX: 0
            ))
        ...
        let invalid = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(constraint008Action(name: "CON-008.invalid", secondRadius: 0))
        )
        #expect(try await adapter.evaluate(responseData: CADJSONBoundedCodec.encode(invalid)).result?.outcome == .invalidSubmission)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform001UsesTheBoundedResponseRouteForExactWrongAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-001")
        let exactAction = transform001Action()
        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(exactAction)
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let exactJSON = try #require(String(data: exactData, encoding: .utf8))
        #expect(exactJSON.contains("\"kind\":\"transform\""))
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform001Action(translationX: 26))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongResponse)
        )
        ...
        let zeroAxisResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform001Action(axis: CADDirection3D(x: 0, y: 0, z: 0)))
        )
        let zeroAxisEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(zeroAxisResponse)
        )
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform002UsesTheBoundedResponseRouteForExactWrongOrderAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-002")
        #expect(request.context.challenge.instruction.contains("rectangle width 40.0 mm height 20.0 mm"))
        #expect(request.context.challenge.instruction.contains("centered at (0.0, 0.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (0.0, 25.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("axis through (0.0, 0.0, 0.0) mm"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform002Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let exactJSON = try #require(String(data: exactData, encoding: .utf8))
        #expect(exactJSON.contains("\"kind\":\"transform\""))
        #expect(exactJSON.contains(#""axisPoint":{"unit":"millimeter","x":0,"y":0,"z":0}"#))
        #expect(exactData.count < 16_384)
        #expect(try CADJSONBoundedCodec.decode(
            CADJSONCandidateResponseEnvelope.self,
            from: exactData
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-002")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)

        let wrongOrderResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform002Action(
        ...
        let wrongOrderEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongOrderResponse)
        )
        #expect(wrongOrderEvaluation.caseID == "TRN-002")
        #expect(wrongOrderEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongOrderEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-002")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform003UsesTheBoundedResponseRouteForExactWrongOrderAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-003")
        #expect(request.context.challenge.instruction.contains("circle radius 10.0 mm"))
        #expect(request.context.challenge.instruction.contains("at (0.0, 0.0, 0.0) mm on the xy plane"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (0.0, 0.0, 50.0) mm"))
        #expect(request.context.challenge.instruction.contains("in direction (1.0, 0.0, 0.0)"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform003Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let exactJSON = try #require(String(data: exactData, encoding: .utf8))
        #expect(exactJSON.contains("\"kind\":\"transform\""))
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-003")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongOrderResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform003Action(translationY: -50, translationZ: 0))
        )
        let wrongOrderEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongOrderResponse)
        )
        #expect(wrongOrderEvaluation.caseID == "TRN-003")
        #expect(wrongOrderEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongOrderEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-003")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform004UsesTheBoundedResponseRouteForExactWrongOrderAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-004")
        #expect(request.context.challenge.instruction.contains("box 20.0 mm x 30.0 mm x 40.0 mm"))
        #expect(request.context.challenge.instruction.contains("at (0.0, 0.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("axis through (10.0, 15.0, 20.0) mm"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (100.0, -50.0, 25.0) mm"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform004Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        #expect(exactData.count < 16_384)
        #expect(try CADJSONBoundedCodec.decode(
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-004")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongOrderResponse = try CADJSONCandidateResponseEnvelope(
            ...
            context: request.context,
            decision: .action(transform004Action(
                translationX: 109.53353488403286,
                translationY: -22.41438680420134
            ))
        )
        let wrongOrderEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongOrderResponse)
        )
        #expect(wrongOrderEvaluation.caseID == "TRN-004")
        #expect(wrongOrderEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongOrderEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-004")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform005UsesTheBoundedResponseRouteForExactWrongOrderAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-005")
        #expect(request.context.challenge.instruction.contains("cylinder radius 8.0 mm depth 40.0 mm"))
        #expect(request.context.challenge.instruction.contains("along axis (0.0, 0.0, 1.0)"))
        #expect(request.context.challenge.instruction.contains("axis through (0.0, 0.0, 20.0) mm"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (-25.0, 50.0, 75.0) mm"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform005Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        #expect(exactData.count < 16_384)
        #expect(try CADJSONBoundedCodec.decode(
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-005")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongOrderResponse = try CADJSONCandidateResponseEnvelope(
            ...
            context: request.context,
            decision: .action(transform005Action(
                translationX: 15.849364905389024,
                translationZ: 77.4519052838329
            ))
        )
        let wrongOrderEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongOrderResponse)
        )
        #expect(wrongOrderEvaluation.caseID == "TRN-005")
        #expect(wrongOrderEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongOrderEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-005")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform006UsesTheBoundedResponseRouteForExactInverseAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-006")
        #expect(request.context.challenge.instruction.contains("line (-30.0, -30.0, 0.0) mm to (30.0, 30.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("axis through (0.0, 0.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("direction (1.0, 0.0, 0.0)"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (0.0, 0.0, 0.0) mm"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform006Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        #expect(exactData.count < 16_384)
        #expect(try CADJSONBoundedCodec.decode(
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-006")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)

        let inverseAxisResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform006Action(
                axis: CADDirection3D(x: -1, y: 0, z: 0)
        ...
        let inverseAxisEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(inverseAxisResponse)
        )
        #expect(inverseAxisEvaluation.caseID == "TRN-006")
        #expect(inverseAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(inverseAxisEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-006")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform007UsesTheBoundedResponseRouteForExactWrongAngleAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-007")
        #expect(request.context.challenge.instruction.contains("rectangle width 100.0 mm height 50.0 mm"))
        #expect(request.context.challenge.instruction.contains("on the yz plane"))
        #expect(request.context.challenge.instruction.contains("axis through (0.0, 0.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (0.0, 0.0, -100.0) mm"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform007Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        #expect(exactData.count < 16_384)
        #expect(try CADJSONBoundedCodec.decode(
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-007")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)

        let wrongAngleResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform007Action(rotationDegrees: 90))
        )
        let wrongAngleEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongAngleResponse)
        )
        #expect(wrongAngleEvaluation.caseID == "TRN-007")
        #expect(wrongAngleEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongAngleEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-007")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func transform008UsesTheBoundedResponseRouteForExactWrongOrderAndZeroAxisActions() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "TRN-008")
        #expect(request.context.challenge.instruction.contains("circle radius 50.0 mm"))
        #expect(request.context.challenge.instruction.contains("at (25.0, -25.0, 0.0) mm on the xy plane"))
        #expect(request.context.challenge.instruction.contains("axis through (25.0, -25.0, 0.0) mm"))
        #expect(request.context.challenge.instruction.contains("then translating the rotated result by (250.0, 125.0, 0.0) mm"))

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(transform008Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        #expect(exactData.count < 16_384)
        #expect(try CADJSONBoundedCodec.decode(
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "TRN-008")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongOrderResponse = try CADJSONCandidateResponseEnvelope(
            ...
            context: request.context,
            decision: .action(transform008Action(
                translationX: 125.00000000000003,
                translationY: 249.99999999999997,
                translationZ: -1.3877787807814457e-14
            ))
        )
        let wrongOrderEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongOrderResponse)
        )
        #expect(wrongOrderEvaluation.caseID == "TRN-008")
        #expect(wrongOrderEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongOrderEvaluation.error == nil)
        ...
        #expect(zeroAxisEvaluation.caseID == "TRN-008")
        #expect(zeroAxisEvaluation.result?.outcome == .invalidSubmission)
        #expect(zeroAxisEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func compound002UsesTheBoundedResponseRouteForExactSwappedOriginsAndZeroDimension() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CMP-002")
        #expect(request.context.challenge.category == .compound)
        #expect(request.context.challenge.instruction == "Construct CMP-002 as a compound containing left=box 25.0 mm x 25.0 mm x 25.0 mm at (-40.0, 0.0, 0.0) mm, right=box 25.0 mm x 25.0 mm x 25.0 mm at (15.0, 0.0, 0.0) mm.")
        #expect(request.context.challenge.outputRoles.map(\.name) == ["left", "right"])
        #expect(request.context.capabilities.statuses.first?.available == true)

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound002Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let requestText = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseText = String(decoding: exactData, as: UTF8.self)
        ...
        #expect(responseText.contains("\"schema\":\"rupa.agent-cad-benchmark.candidate-response.v8\""))
        #expect(responseText.contains("\"kind\":\"compound\""))
        let leftRole = try #require(responseText.range(of: "\"role\":\"left\""))
        let rightRole = try #require(responseText.range(of: "\"role\":\"right\""))
        #expect(leftRole.lowerBound < rightRole.lowerBound)
        for forbidden in ["expectation", "oracle", "sourceTopology", "telemetry", "workspace", "FeatureID"] {
            #expect(requestText.contains(forbidden) == false)
            #expect(responseText.contains(forbidden) == false)
        }
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "CMP-002")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound002Action(leftOriginX: 15, rightOriginX: -40))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongResponse)
        )
        #expect(wrongEvaluation.caseID == "CMP-002")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
        ...
        let invalidResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound002Action(rightWidth: 0))
        )
        let invalidEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(invalidResponse)
        )
        #expect(invalidEvaluation.caseID == "CMP-002")
        #expect(invalidEvaluation.result?.outcome == .invalidSubmission)
        #expect(invalidEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func compound004UsesTheBoundedResponseRouteForExactSwappedPinsAndZeroRadius() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CMP-004")
        #expect(request.context.challenge.category == .compound)
        #expect(request.context.challenge.instruction == "Construct CMP-004 as a compound containing plate=box 200.0 mm x 100.0 mm x 10.0 mm at (0.0, 0.0, 0.0) mm, pin-a=cylinder radius 8.0 mm depth 50.0 mm at (25.0, 25.0, 10.0) mm along axis (0.0, 0.0, 1.0), pin-b=cylinder radius 8.0 mm depth 50.0 mm at (175.0, 25.0, 10.0) mm along axis (0.0, 0.0, 1.0).")
        #expect(request.context.challenge.outputRoles.map(\.name) == ["plate", "pin-a", "pin-b"])
        #expect(request.context.capabilities.statuses.first?.available == true)

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound004Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let requestText = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseText = String(decoding: exactData, as: UTF8.self)
        ...
        #expect(responseText.contains("\"schema\":\"rupa.agent-cad-benchmark.candidate-response.v8\""))
        #expect(responseText.contains("\"kind\":\"compound\""))
        let plateRole = try #require(responseText.range(of: "\"role\":\"plate\""))
        let pinARole = try #require(responseText.range(of: "\"role\":\"pin-a\""))
        let pinBRole = try #require(responseText.range(of: "\"role\":\"pin-b\""))
        #expect(plateRole.lowerBound < pinARole.lowerBound)
        #expect(pinARole.lowerBound < pinBRole.lowerBound)
        for forbidden in ["expectation", "oracle", "sourceTopology", "telemetry", "workspace", "FeatureID"] {
            #expect(requestText.contains(forbidden) == false)
            #expect(responseText.contains(forbidden) == false)
        }
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "CMP-004")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound004Action(swappingPinPayloads: true))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongResponse)
        )
        #expect(wrongEvaluation.caseID == "CMP-004")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
        ...
        let invalidResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound004Action(pinBRadius: 0))
        )
        let invalidEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(invalidResponse)
        )
        #expect(invalidEvaluation.caseID == "CMP-004")
        #expect(invalidEvaluation.result?.outcome == .invalidSubmission)
        #expect(invalidEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func compound005UsesTheBoundedResponseRouteForExactSwappedUprightsAndZeroDimension() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CMP-005")
        #expect(request.context.challenge.category == .compound)
        ...
        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound005Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let requestText = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseText = String(decoding: exactData, as: UTF8.self)
        ...
        #expect(responseText.contains("\"schema\":\"rupa.agent-cad-benchmark.candidate-response.v8\""))
        #expect(responseText.contains("\"kind\":\"compound\""))
        let frameRole = try #require(responseText.range(of: "\"role\":\"frame\""))
        let uprightARole = try #require(responseText.range(of: "\"role\":\"upright-a\""))
        let uprightBRole = try #require(responseText.range(of: "\"role\":\"upright-b\""))
        #expect(frameRole.lowerBound < uprightARole.lowerBound)
        #expect(uprightARole.lowerBound < uprightBRole.lowerBound)
        for forbidden in ["expectation", "oracle", "sourceTopology", "telemetry", "workspace", "FeatureID"] {
            #expect(requestText.contains(forbidden) == false)
            #expect(responseText.contains(forbidden) == false)
        }
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "CMP-005")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound005Action(swappingUprightPayloads: true))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongResponse)
        )
        ...
        let invalidResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound005Action(uprightBWidth: 0))
        )
        let invalidEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(invalidResponse)
        )
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func compound006UsesTheBoundedResponseRouteForExactSwappedArmsAndZeroDimension() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CMP-006")
        #expect(request.context.challenge.category == .compound)
        #expect(request.context.challenge.instruction == "Construct CMP-006 as a compound containing hub=cylinder radius 20.0 mm depth 50.0 mm at (0.0, 0.0, 0.0) mm along axis (0.0, 0.0, 1.0), arm-a=box 100.0 mm x 10.0 mm x 10.0 mm at (20.0, -5.0, 20.0) mm, arm-b=box 100.0 mm x 10.0 mm x 10.0 mm at (-120.0, -5.0, 20.0) mm.")
        #expect(request.context.challenge.outputRoles.map(\.name) == ["hub", "arm-a", "arm-b"])
        #expect(request.context.capabilities.statuses.first?.available == true)

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound006Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let requestText = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseText = String(decoding: exactData, as: UTF8.self)
        ...
        #expect(responseText.contains("\"schema\":\"rupa.agent-cad-benchmark.candidate-response.v8\""))
        #expect(responseText.contains("\"kind\":\"compound\""))
        let hubRole = try #require(responseText.range(of: "\"role\":\"hub\""))
        let armARole = try #require(responseText.range(of: "\"role\":\"arm-a\""))
        let armBRole = try #require(responseText.range(of: "\"role\":\"arm-b\""))
        #expect(hubRole.lowerBound < armARole.lowerBound)
        #expect(armARole.lowerBound < armBRole.lowerBound)
        for forbidden in ["expectation", "oracle", "sourceTopology", "telemetry", "workspace", "FeatureID"] {
            #expect(requestText.contains(forbidden) == false)
            #expect(responseText.contains(forbidden) == false)
        }
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "CMP-006")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound006Action(swappingArmPayloads: true))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongResponse)
        )
        #expect(wrongEvaluation.caseID == "CMP-006")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
        ...
        let invalidResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound006Action(armBWidth: 0))
        )
        let invalidEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(invalidResponse)
        )
        #expect(invalidEvaluation.caseID == "CMP-006")
        #expect(invalidEvaluation.result?.outcome == .invalidSubmission)
        #expect(invalidEvaluation.error == nil)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func compound007UsesTheBoundedResponseRouteForExactOffsetAndDegenerateBore() async throws {
        let adapter = CADJSONAdapter()
        let request = try adapter.makeRequest(for: "CMP-007")
        #expect(request.context.challenge.category == .compound)
        #expect(request.context.challenge.instruction == "Construct CMP-007 as a compound containing block=box 50.0 mm x 50.0 mm x 50.0 mm at (0.0, 0.0, 0.0) mm, bore=cylinder radius 10.0 mm depth 50.0 mm at (25.0, 25.0, 0.0) mm along axis (0.0, 0.0, 1.0).")
        #expect(request.context.challenge.outputRoles.map(\.name) == ["block", "bore"])
        #expect(request.context.capabilities.statuses.first?.available == true)

        let exactResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound007Action())
        )
        let exactData = try CADJSONBoundedCodec.encode(exactResponse)
        let requestText = String(decoding: try CADJSONBoundedCodec.encode(request), as: UTF8.self)
        let responseText = String(decoding: exactData, as: UTF8.self)
        ...
        #expect(responseText.contains("\"schema\":\"rupa.agent-cad-benchmark.candidate-response.v8\""))
        #expect(responseText.contains("\"kind\":\"compound\""))
        let blockRole = try #require(responseText.range(of: "\"role\":\"block\""))
        let boreRole = try #require(responseText.range(of: "\"role\":\"bore\""))
        #expect(blockRole.lowerBound < boreRole.lowerBound)
        for forbidden in ["expectation", "oracle", "sourceTopology", "telemetry", "workspace", "FeatureID"] {
            #expect(requestText.contains(forbidden) == false)
            #expect(responseText.contains(forbidden) == false)
        }
        ...
        let exactEvaluation = try await adapter.evaluate(responseData: exactData)
        #expect(exactEvaluation.caseID == "CMP-007")
        #expect(exactEvaluation.result?.outcome == .realized)
        #expect(exactEvaluation.error == nil)
        ...
        let wrongResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(compound007Action(boreBaseX: 26))
        )
        let wrongEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(wrongResponse)
        )
        #expect(wrongEvaluation.caseID == "CMP-007")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)

        for invalidAction in [
            compound007Action(boreRadius: 0),
            compound007Action(boreAxis: CADDirection3D(x: 0, y: 0, z: 0)),
        ] {
            let invalidResponse = try CADJSONCandidateResponseEnvelope(
                caseID: request.caseID,
                context: request.context,
                decision: .action(invalidAction)
            )
            let invalidEvaluation = try await adapter.evaluate(
                responseData: CADJSONBoundedCodec.encode(invalidResponse)
            )
            #expect(invalidEvaluation.caseID == "CMP-007")
            #expect(invalidEvaluation.result?.outcome == .invalidSubmission)
            #expect(invalidEvaluation.error == nil)
        }
    ...
    func sphere001UsesUnavailableContextAndTypedUnsupportedResponseRoute() async throws {
        ...
        #expect(request.context.challenge.instruction == "Construct SPH-001 as an analytic sphere of radius 5.0 mm centered at (0.0, 0.0, 0.0) mm.")
        ...
        #expect(wrongEvaluation.caseID == "SPH-001")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
    ...
    func sphere003UsesMeterScaleUnavailableContextAndTypedUnsupportedResponseRoute() async throws {
        ...
        let substituteResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(box001Action(name: "SPH-003.substitute"))
        )
        let substituteEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(substituteResponse)
        )
    ...
    func sphere004UsesImperialUnavailableContextAndTypedUnsupportedResponseRoute() async throws {
        ...
        #expect(request.context.challenge.category == .sphere)
        #expect(request.context.challenge.instruction == "Construct SPH-004 as an analytic sphere of radius 2.0 in centered at (-2.0, 3.0, 1.0) in.")
        #expect(request.context.challenge.outputRoles.map(\.name) == ["sphere"])
        #expect(request.context.challenge.requiredCapability.id == "cad.solid.analytic-sphere")
        let status = try #require(request.context.capabilities.statuses.first)
        #expect(request.context.capabilities.statuses.count == 1)
        ...
        let substituteResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(box001Action(name: "SPH-004.substitute"))
        )
        let substituteEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(substituteResponse)
        )
        #expect(substituteEvaluation.caseID == "SPH-004")
        #expect(substituteEvaluation.result?.outcome == .invalidSubmission)
        #expect(substituteEvaluation.error == nil)
        ...
        #expect(wrongEvaluation.caseID == "SPH-004")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
    ...
    func sphere005UsesLargeTranslatedUnavailableContextAndTypedUnsupportedResponseRoute() async throws {
        ...
        #expect(request.context.challenge.category == .sphere)
        #expect(request.context.challenge.instruction == "Construct SPH-005 as an analytic sphere of radius 100.0 mm centered at (-100.0, 100.0, -50.0) mm.")
        #expect(request.context.challenge.outputRoles.map(\.name) == ["sphere"])
        #expect(request.context.challenge.requiredCapability.id == "cad.solid.analytic-sphere")
        let status = try #require(request.context.capabilities.statuses.first)
        #expect(request.context.capabilities.statuses.count == 1)
        ...
        let substituteResponse = try CADJSONCandidateResponseEnvelope(
            caseID: request.caseID,
            context: request.context,
            decision: .action(box001Action(name: "SPH-005.substitute"))
        )
        let substituteEvaluation = try await adapter.evaluate(
            responseData: CADJSONBoundedCodec.encode(substituteResponse)
        )
        #expect(substituteEvaluation.caseID == "SPH-005")
        #expect(substituteEvaluation.result?.outcome == .invalidSubmission)
        #expect(substituteEvaluation.error == nil)
        ...
        #expect(wrongEvaluation.caseID == "SPH-005")
        #expect(wrongEvaluation.result?.outcome == .invalidSubmission)
        #expect(wrongEvaluation.error == nil)
    }
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func requestAndLiveContextsAreValueEqualAndAllOneHundredRequestsStayBounded() throws {
        ...
        for caseID in executor.activatedCaseIDs {
            ...
            } else if caseID.rawValue == "CYL-003" {
                action = cylinder003Action(name: caseID.rawValue)
            } else if caseID.rawValue == "CYL-004" {
            ...
            } else if caseID.rawValue == "CYL-007" {
                action = cylinder007Action(name: caseID.rawValue)
            } else if caseID.rawValue == "CYL-008" {
                action = cylinder008Action(name: caseID.rawValue)
            ...
            } else if caseID.rawValue == "TRN-001" {
                action = transform001Action()
            } else if caseID.rawValue == "TRN-002" {
                action = transform002Action()
            } else if caseID.rawValue == "TRN-003" {
                action = transform003Action()
            } else if caseID.rawValue == "TRN-004" {
                action = transform004Action()
            } else if caseID.rawValue == "TRN-005" {
                action = transform005Action()
            } else if caseID.rawValue == "TRN-006" {
                action = transform006Action()
            } else if caseID.rawValue == "TRN-007" {
            ...
            } else if caseID.rawValue == "CMP-004" {
                action = compound004Action()
            } else if caseID.rawValue == "CMP-005" {
                action = compound005Action()
            } else if caseID.rawValue == "CMP-006" {
    ...
    func activatedRequestSequenceHasAStableLengthPrefixedAggregateDigest() throws {
        ...
        let cylinder003ID: CADBenchmarkCaseID = "CYL-003"
        let cylinder003Request = try adapter.encodeRequest(for: cylinder003ID)
        appendLengthPrefixed(Data(cylinder003ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(cylinder003Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: cylinder003Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "c6d27d83af09579d4d4526dbd3f27c212af7ccaa1d17b878c60dd3ae9f7991e8")

        let cylinder004ID: CADBenchmarkCaseID = "CYL-004"
        let cylinder004Request = try adapter.encodeRequest(for: cylinder004ID)
        appendLengthPrefixed(Data(cylinder004ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(cylinder004Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: cylinder004Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "ff509e72f694e60034ee330591408c0dbb49b7bdbf1a0246f022abcb1cf8b342")

        let cylinder005ID: CADBenchmarkCaseID = "CYL-005"
        let cylinder005Request = try adapter.encodeRequest(for: cylinder005ID)
        appendLengthPrefixed(Data(cylinder005ID.rawValue.utf8), to: &currentAggregate)
        ...
        let cylinder007ID: CADBenchmarkCaseID = "CYL-007"
        let cylinder007Request = try adapter.encodeRequest(for: cylinder007ID)
        appendLengthPrefixed(Data(cylinder007ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(cylinder007Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: cylinder007Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "f4960441dea3fe2dc3984b3c093d8a77699990a7f5e055c5a300cf09133baf5d")

        let cylinder008ID: CADBenchmarkCaseID = "CYL-008"
        let cylinder008Request = try adapter.encodeRequest(for: cylinder008ID)
        appendLengthPrefixed(Data(cylinder008ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(cylinder008Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: cylinder008Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "842be9af6961688359198c5d7cda9d8134c36e9a07d56cbf5fe1e4b409cc9cea")

        let constraint001ID: CADBenchmarkCaseID = "CON-001"
        let constraint001Request = try adapter.encodeRequest(for: constraint001ID)
        appendLengthPrefixed(Data(constraint001ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(constraint001Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: constraint001Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "efc4fac5670c6739132f6145b5fc18ed38f69b1fe5dfd9889e2b38603de75468")

        let constraint002ID: CADBenchmarkCaseID = "CON-002"
        let constraint002Request = try adapter.encodeRequest(for: constraint002ID)
        appendLengthPrefixed(Data(constraint002ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(constraint002Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: constraint002Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "6f9d75f040f25352de1a8b3b7b7cfa68fb5fe06118bf93875dfbf696ebc2b851")

        let constraint003ID: CADBenchmarkCaseID = "CON-003"
        let constraint003Request = try adapter.encodeRequest(for: constraint003ID)
        appendLengthPrefixed(Data(constraint003ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(constraint003Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: constraint003Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "9a9759ff74dbe5222940164edbbb60040f732453889fe2648ed0c2e205e6e69c")

        let constraint004ID: CADBenchmarkCaseID = "CON-004"
        let constraint004Request = try adapter.encodeRequest(for: constraint004ID)
        appendLengthPrefixed(Data(constraint004ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(constraint004Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: constraint004Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "8878fa7dc59023aba4097c833bcca24f793829df83d8ad42106c8efebb985b79")

        let constraint005ID: CADBenchmarkCaseID = "CON-005"
        let constraint005Request = try adapter.encodeRequest(for: constraint005ID)
        appendLengthPrefixed(Data(constraint005ID.rawValue.utf8), to: &currentAggregate)
        ...
        let constraint007ID: CADBenchmarkCaseID = "CON-007"
        let constraint007Request = try adapter.encodeRequest(for: constraint007ID)
        appendLengthPrefixed(Data(constraint007ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(constraint007Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: constraint007Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "d893db3650a26a276826b09dd4825d1f032d03a4faf11abf3e1d2d65caa13136")

        let constraint008ID: CADBenchmarkCaseID = "CON-008"
        let constraint008Request = try adapter.encodeRequest(for: constraint008ID)
        appendLengthPrefixed(Data(constraint008ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(constraint008Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: constraint008Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "91f68ea42c6e131263b499995637e9f9b7dbce64fcf441bdcdf385c9f341efb0")

        let transform001ID: CADBenchmarkCaseID = "TRN-001"
        let transform001Request = try adapter.encodeRequest(for: transform001ID)
        appendLengthPrefixed(Data(transform001ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform001Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform001Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "e4c0ad812c421428ed59c7dd2671922e9e1f667af3f574d0ea87a461e53aab82")

        let transform002ID: CADBenchmarkCaseID = "TRN-002"
        let transform002Request = try adapter.encodeRequest(for: transform002ID)
        appendLengthPrefixed(Data(transform002ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform002Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform002Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "9ca519a087729b5aa46e549ef3ec6f903158a8aff159dce2bcce09182f0b46ef")

        let transform003ID: CADBenchmarkCaseID = "TRN-003"
        let transform003Request = try adapter.encodeRequest(for: transform003ID)
        appendLengthPrefixed(Data(transform003ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform003Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform003Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "02a7bfa19eed2aa8cdef578058a97b48b5e88822840cbd23343590a8281b579a")

        let transform004ID: CADBenchmarkCaseID = "TRN-004"
        let transform004Request = try adapter.encodeRequest(for: transform004ID)
        appendLengthPrefixed(Data(transform004ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform004Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform004Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "c4d86468d4992df1030e0ed45c98b823f33caa9bf904ea7a6252950c95f017d0")

        let transform005ID: CADBenchmarkCaseID = "TRN-005"
        let transform005Request = try adapter.encodeRequest(for: transform005ID)
        appendLengthPrefixed(Data(transform005ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform005Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform005Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "c5c61320be710e1fe290b86e25ad9afb83b2d687c608c13aa3b4c6e2ee100779")

        let transform006ID: CADBenchmarkCaseID = "TRN-006"
        let transform006Request = try adapter.encodeRequest(for: transform006ID)
        appendLengthPrefixed(Data(transform006ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform006Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform006Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "f7061d03903393f8384f3c23eed29c4eb4ef8529e27f03fca5e268e698b01f90")

        let transform007ID: CADBenchmarkCaseID = "TRN-007"
        let transform007Request = try adapter.encodeRequest(for: transform007ID)
        appendLengthPrefixed(Data(transform007ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(transform007Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: transform007Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "d1c0aaf385f5f67658a5052f26f3b38cf4970ce5377a9f282e8022f3dcd482ec")

        let transform008ID: CADBenchmarkCaseID = "TRN-008"
        let transform008Request = try adapter.encodeRequest(for: transform008ID)
        appendLengthPrefixed(Data(transform008ID.rawValue.utf8), to: &currentAggregate)
        ...
        let compound002ID: CADBenchmarkCaseID = "CMP-002"
        let compound002Request = try adapter.encodeRequest(for: compound002ID)
        appendLengthPrefixed(Data(compound002ID.rawValue.utf8), to: &currentAggregate)
        ...
        let compound004ID: CADBenchmarkCaseID = "CMP-004"
        let compound004Request = try adapter.encodeRequest(for: compound004ID)
        appendLengthPrefixed(Data(compound004ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(compound004Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: compound004Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "e1984e09864c758b0876c386ddef9bab3f810716f9c1b44dbe1e3c46df082a27")

        let compound005ID: CADBenchmarkCaseID = "CMP-005"
        let compound005Request = try adapter.encodeRequest(for: compound005ID)
        appendLengthPrefixed(Data(compound005ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(compound005Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: compound005Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "bcb6db981a67668a16a18c2654ec2b6465668d7a8396761bfc3bacdcbe7d67dc")

        let compound006ID: CADBenchmarkCaseID = "CMP-006"
        let compound006Request = try adapter.encodeRequest(for: compound006ID)
        appendLengthPrefixed(Data(compound006ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(compound006Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: compound006Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "978ee6b0ac70c3d90a87b0f44fb634d4aec0fbaf42126db9ed8721bec7431c43")

        let compound007ID: CADBenchmarkCaseID = "CMP-007"
        let compound007Request = try adapter.encodeRequest(for: compound007ID)
        appendLengthPrefixed(Data(compound007ID.rawValue.utf8), to: &currentAggregate)
        appendLengthPrefixed(bigEndianBytes(UInt64(compound007Request.count)), to: &currentAggregate)
        appendLengthPrefixed(Data(SHA256.hash(data: compound007Request)), to: &currentAggregate)
        #expect(sha256Hex(currentAggregate) == "f9060999bba0bfa121bca51593fe5468c67b0237eebb0b0f82acd2feaf66fe1a")

        let sphere001ID: CADBenchmarkCaseID = "SPH-001"
        let sphere001Request = try adapter.encodeRequest(for: sphere001ID)
    ...
    @MainActor
    @Test(.timeLimit(.minutes(1)))
    func preBindingSchemaCaseAndFingerprintFailuresAreTypedThrows() async throws {
        let adapter = CADJSONAdapter()
        let lineRequest = try adapter.makeRequest(for: "LIN-001")
    ...
    func candidateResponseV1ThroughV7AreRejectedBeforeDecisionDecode() throws {
        ...
        let v5WithUnknownDecision = Data(#"{"schema":"rupa.agent-cad-benchmark.candidate-response.v5","decision":{"kind":"future"}}"#.utf8)
        expectAdapterError(.unsupportedSchema) {
            _ = try CADJSONBoundedCodec.decode(
                CADJSONCandidateResponseEnvelope.self,
                from: v5WithUnknownDecision
            )
        }
        ...
        let v6WithUnknownDecision = Data(#"{"schema":"rupa.agent-cad-benchmark.candidate-response.v6","decision":{"kind":"future"}}"#.utf8)
        expectAdapterError(.unsupportedSchema) {
            _ = try CADJSONBoundedCodec.decode(
                CADJSONCandidateResponseEnvelope.self,
...
private func transform003Action(
    translationY: Double = 0,
    translationZ: Double = 50,
    ...
    .automation(.transform(CADTransformAction(
        ...
        axisPoint: CADPoint3D(x: 0, y: 0, z: 0, unit: .millimeter),
        rotationAxis: axis,
        rotation: CADAngle(value: 90, unit: .degree)
    )))
}

private func transform004Action(
    translationX: Double = 100,
    translationY: Double = -50,
    axis: CADDirection3D = CADDirection3D(x: 0, y: 0, z: 1)
) -> CADCandidateAction {
    .automation(.transform(CADTransformAction(
        translation: CADPoint3D(
        ...
        axisPoint: CADPoint3D(x: 10, y: 15, z: 20, unit: .millimeter),
        rotationAxis: axis,
        rotation: CADAngle(value: 15, unit: .degree)
    )))
}

private func transform005Action(
    translationX: Double = -25,
    translationZ: Double = 75,
    ...
    .automation(.transform(CADTransformAction(
        ...
        axisPoint: CADPoint3D(x: 0, y: 0, z: 20, unit: .millimeter),
        rotationAxis: axis,
        rotation: CADAngle(value: 30, unit: .degree)
    )))
}

private func transform006Action(
    axis: CADDirection3D = CADDirection3D(x: 1, y: 0, z: 0)
) -> CADCandidateAction {
    .automation(.transform(CADTransformAction(
        ...
        axisPoint: CADPoint3D(x: 0, y: 0, z: 0, unit: .millimeter),
        rotationAxis: axis,
        rotation: CADAngle(value: 120, unit: .degree)
    )))
}

private func transform007Action(
    ...
    .automation(.transform(CADTransformAction(
        ...
        axisPoint: CADPoint3D(x: 0, y: 0, z: 0, unit: .millimeter),
        rotationAxis: axis,
        rotation: CADAngle(value: rotationDegrees, unit: .degree)
    )))
}

private func transform008Action(
    translationX: Double = 250,
    translationY: Double = 125,
    translationZ: Double = 0,
    ...
    .automation(.transform(CADTransformAction(
        ...
        axisPoint: CADPoint3D(x: 25, y: -25, z: 0, unit: .millimeter),
        rotationAxis: axis,
...
private func compound002Action(
    leftOriginX: Double = -40,
    rightOriginX: Double = 15,
    rightWidth: Double = 25
) -> CADCandidateAction {
    .compound(CADCompoundAction(members: [
        CADCompoundMemberAction(
            role: "left",
            name: "CMP-002.left",
            origin: CADPoint3D(x: leftOriginX, y: 0, z: 0, unit: .millimeter),
        ...
        CADCompoundMemberAction(
            role: "right",
            name: "CMP-002.right",
            origin: CADPoint3D(x: rightOriginX, y: 0, z: 0, unit: .millimeter),
...
private func compound004Action(
    swappingPinPayloads: Bool = false,
    pinBRadius: Double = 8
) -> CADCandidateAction {
    let pinABaseX = swappingPinPayloads ? 175.0 : 25.0
    let pinBBaseX = swappingPinPayloads ? 25.0 : 175.0
    let axis = CADDirection3D(x: 0, y: 0, z: 1)
    ...
    return .compound(CADCompoundAction(members: [
        ...
        CADCompoundMemberAction(
            role: "pin-a",
            name: "CMP-004.pin-a",
            baseCenter: CADPoint3D(x: pinABaseX, y: 25, z: 10, unit: .millimeter),
            axis: axis,
        ...
        CADCompoundMemberAction(
            role: "pin-b",
            name: "CMP-004.pin-b",
            baseCenter: CADPoint3D(x: pinBBaseX, y: 25, z: 10, unit: .millimeter),
            axis: axis,
...
private func compound006Action(
    swappingArmPayloads: Bool = false,
    armBWidth: Double = 100
) -> CADCandidateAction {
    let armAOriginX = swappingArmPayloads ? -120.0 : 20.0
    let armBOriginX = swappingArmPayloads ? 20.0 : -120.0
    ...
    return .compound(CADCompoundAction(members: [
        CADCompoundMemberAction(
            ...
            axis: CADDirection3D(x: 0, y: 0, z: 1),
            radius: CADLength(value: 20, unit: .millimeter),
            depth: CADLength(value: 50, unit: .millimeter)
        ),
        CADCompoundMemberAction(
            role: "arm-a",
            name: "CMP-006.arm-a",
            origin: CADPoint3D(x: armAOriginX, y: -5, z: 20, unit: .millimeter),
            width: CADLength(value: 100, unit: .millimeter),
        ...
        CADCompoundMemberAction(
            role: "arm-b",
            name: "CMP-006.arm-b",
            origin: CADPoint3D(x: armBOriginX, y: -5, z: 20, unit: .millimeter),
            width: CADLength(value: armBWidth, unit: .millimeter),
            depth: CADLength(value: 10, unit: .millimeter),
            height: CADLength(value: 10, unit: .millimeter)
        ),
    ]))
...
private func compound007Action(
    boreBaseX: Double = 25,
    boreRadius: Double = 10,
    boreAxis: CADDirection3D = CADDirection3D(x: 0, y: 0, z: 1)
) -> CADCandidateAction {
    .compound(CADCompoundAction(members: [
        CADCompoundMemberAction(
            role: "block",
        ...
        CADCompoundMemberAction(
            role: "bore",
            name: "CMP-007.bore",
            baseCenter: CADPoint3D(x: boreBaseX, y: 25, z: 0, unit: .millimeter),
            axis: boreAxis,
            radius: CADLength(value: boreRadius, unit: .millimeter),
            depth: CADLength(value: 50, unit: .millimeter)
        ),
    ]))
}
