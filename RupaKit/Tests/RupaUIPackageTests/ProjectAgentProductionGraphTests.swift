...
func projectAgentSemanticRoutesAreExplicitAndRawPayloadsHaveNoProductionOwner() throws {
    ...
    #expect(controllerSource.contains("executeSemanticDirect"))
    #expect(controllerSource.contains("executeSemanticProgram"))
    #expect(controllerSource.contains("workspace.executeSemanticProgram"))
    #expect(controllerSource.contains("FIXME(INCOMPLETE_IMPLEMENTATION)") == false)
