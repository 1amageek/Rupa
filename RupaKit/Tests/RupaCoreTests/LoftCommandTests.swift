...
@Test func createLoftAddsSourceFeatureSceneObjectAndEvaluatedSolid() throws {
    ...
    #expect(measurement.diagnostics.map(\.code) == [.measurementTessellatedSolidApproximation])
...
@Test func createLoftCanCreateSheetResult() throws {
    ...
    #expect(measurement.diagnostics.map(\.code) == [.measurementTessellatedSheetApproximation])
