...
@Test func surfaceSourceSummaryReportsAuthoredTrimParameterCurveControlPoints() async throws {
    ...
    #expect(bSplineEdge.parameterCurve.kind == "bSpline")
    #expect(bSplineEdge.parameterCurve.degree == 2)
    #expect(bSplineEdge.parameterCurve.order == 3)
    #expect(bSplineEdge.parameterCurve.domainLowerBound == 0.0)
    #expect(bSplineEdge.parameterCurve.domainUpperBound == 1.0)
    ...
    #expect(polylineEdge.parameterCurve.kind == "polyline")
    #expect(polylineEdge.parameterCurve.supportsKnotInsertion == false)
    #expect(polylineEdge.parameterCurve.unsupportedReason?.contains("B-splines") == true)
