...
|---|---|---|
| `RupaCore/DesignDocument.swift` | Command facade still contains sketch, surface, and remaining shared helper implementations | Move high-cohesion command families into `DesignDocument+Sketch`, `DesignDocument+Surface`, and shared internal command utilities |
