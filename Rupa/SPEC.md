...
| `rupa sketch constraint-add <document> --feature-id <uuid> --constraint <json>` | Add one supported sketch constraint through the shared Automation/Core command path. |
