...
| 3 | `CAD_MESH_RESPONSIBILITY_CONTRACT.md`, `STATE_AND_PROJECT_CONTRACT.md`, `DOCUMENT_PACKAGE_CONTRACT.md`, `DOMAIN_EXTENSION_ARCHITECTURE.md`, `REFERENCE_ARTIFACT_CONTRACT.md`, `DOMAIN_TRANSACTION_CONTRACT.md`, `VALIDATION_CONTRACT.md`, and `AUTOMATION_PROTOCOL.md` | Define CAD/Mesh authority, state lifetime, dependency, ownership, package, identity, transaction, validation, protocol, evaluation, reconstruction-input, and derived-artifact invariants. |
